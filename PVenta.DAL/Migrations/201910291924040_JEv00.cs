namespace PVenta.DAL.Migrations
{
    ...
    public partial class JEv00 : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.LogEventos", "UserId", "dbo.Usuarios");
            DropForeignKey("dbo.CuadreDetails", "MonedaId", "dbo.Monedas");
            DropIndex("dbo.LogEventos", new[] { "UserId" });
            DropIndex("dbo.CuadreDetails", new[] { "MonedaId" });
            DropTable("dbo.Roles");
            DropTable("dbo.Productos");
            DropTable("dbo.PermisosRol");
            DropTable("dbo.OpcionesSist");
            DropTable("dbo.Mesas");
