...
{
    public class MConfigSistemaProfile : Profile
    {
        public MConfigSistemaProfile()
        {
            CreateMap<ConfigSistema, ApiConfigSistema>()
                ...
                .ForMember(dest => dest.DiasFactura, opts => opts.MapFrom(src => src.DiasFactura))
                .ForMember(dest => dest.MensajeOrden, opts => opts.MapFrom(src => src.MensajeOrden))
                .ForMember(dest => dest.DiasOrden, opts => opts.MapFrom(src => src.DiasOrden))
